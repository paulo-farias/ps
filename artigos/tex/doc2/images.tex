...
\usepackage[left = 1.7cm, bottom = 2cm, right = 1.7cm]{geometry}
...
\graphicspath{{/home/paulo/Documentos/projetos/artigo-tex/tex-2/pasta sem título/pic/}{../pic/}}
...
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap123}%
\includegraphics[width=2.6cm, height= 1.6cm]{sxpc}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap124}%
\includegraphics[width=3cm, height= 2.3cm]{sxc}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
